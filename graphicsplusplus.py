...
"""
graphicsplusplus.py
a extension/modification of the graphics.py module for python.
last modified 6/10/15
import it like so: from graphicsplusplus.py import *
it must be in the same vicinity as the python file you are using
for questions, comments, concerns contact verbsapa@gmail.com
"""
'''
The original graphics library was designed to make it very easy for novice programmers to
experiment with computer graphics in an object oriented fashion. It was
written by John Zelle for use with the book "Python Programming: An
Introduction to Computer Science" (Franklin, Beedle & Associates).

LICENSE: This is modified-from-source software released under the copyleft terms of the original module, under
GPL (http://www.gnu.org/licenses/gpl.html).

http://mcsp.wartburg.edu/zelle/python for orignal graphics module
...
class Ellipse(Oval):
    def __init__(self, center, x_axis, y_axis):
        p1 = Point(center.x - (x_axis/2), center.y - (y_axis/2))
        p2 = Point(center.x + (x_axis/2), center.y + (y_axis/2))
        Oval.__init(self, p1, p2)
        self.x_axis = x_axis
        self.y_axis = y_axis
    def clone(self):
        other = Ellipse(self.getCenter, self.x_axis, self.y_axis)
        other.config = self.config.copy()
        return other
